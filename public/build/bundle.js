...
var app = (function () {
    ...
    const file$5 = "src\\pages\\chapter_editor.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(img0, file$5, 253, 5, 5682);
    			...
    			add_location(img1, file$5, 254, 5, 5741);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 235, 0, 4875);
    			attr_dev(h2, "class", "svelte-1d64fkf");
    			add_location(h2, file$5, 245, 0, 5380);
    			attr_dev(div1, "class", "chapter_list svelte-1d64fkf");
    			add_location(div1, file$5, 247, 0, 5409);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if_block.c();
    			attr_dev(h1, "class", "svelte-5ngbll");
    			add_location(h1, file$6, 25, 1, 362);
    			attr_dev(div, "class", "wrapper svelte-5ngbll");
    			add_location(div, file$6, 24, 0, 339);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
